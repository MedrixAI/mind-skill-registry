---
name: install-skill
description: Install agent skills from various sources including local paths, GitHub
  URLs, or the dot-agents repository. Use when adding new skills to a project or user
  environment.
license: MIT
allowed-tools:
- Bash
- Read
metadata:
  mind.id: ai.medrix.skill.install-skill
  ...
  mind.upstream.path: skills/meta/install-skill/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.evidence-urls: '["https://github.com/tnez/dot-agents/blob/f0427921b26697f792e5f7d47eecefe25d7caff0/LICENSE",
    "https://raw.githubusercontent.com/tnez/dot-agents/f0427921b26697f792e5f7d47eecefe25d7caff0/skills/meta/install-skill/SKILL.md"]'
---
