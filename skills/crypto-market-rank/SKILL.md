...
description: 'Crypto market leaderboards — ranked aggregate feeds across the whole
  market:

  social-hype/sentiment rank, trending / top-search / Binance Alpha / tokenized-stocks
  rank,

  smart-money net-inflow rank (which tokens received the most inflow), top meme tokens
  by breakout score on Pulse launchpad,

  top trader PnL leaderboard (ALL / KOL).

  Use whenever the user wants a ranked list of tokens or addresses by some metric
  — phrases like

  "trending tokens", "top N by hype", "leaderboard", "rank by X", "biggest inflows",
...
metadata:
  ...
  version: '3.0'
  mind.id: ai.medrix.skill.crypto-market-rank
  mind.distribution: marketplace
  mind.market-primary: data-analysis
  mind.market-categories: '["data-analysis"]'
  mind.marketplace-summary: crypto-market-rank
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Crypto market leaderboards — ranked aggregate feeds across the whole market:\nsocial-hype/sentiment rank, trending / top-search / Binance Alpha / tokenized-stocks rank,\nsmart-money net-inflow rank (which tokens received the most inflow), top meme tokens by breakout score on Pulse launchpad,\ntop trader PnL leaderboard (ALL / KOL).\nUse whenever the user wants a ranked list of tokens or addresses by some metric — phrases like\n\"trending tokens\", \"top N by hype\", \"leaderboard\", \"rank by X\", \"biggest inflows\", \"top traders this week\".\n","starter_prompts":["Help me complete a crypto market rank task. Start by asking for the data, decision question, metrics, constraints, and required output, then perform the analysis.","Analyze the data I provide with crypto market rank, check quality and assumptions, surface patterns and anomalies, and summarize actionable findings.","Compare the scenarios or options I provide using crypto market rank, show the supporting evidence, and recommend the next action."]},"zh-CN":{"description":"提供全市场加密资产排行榜，包括社交热度、趋势与搜索、资金净流入、meme 代币突破分数和交易员盈亏榜。适用于按指标查询热门代币或地址排行。","starter_prompts":["请帮我完成crypto market rank任务。先询问数据、决策问题、指标、约束和所需输出，然后执行分析。","请使用crypto market rank分析我提供的数据，检查数据质量与假设，发现模式和异常，并总结可执行的洞察。","请使用crypto market rank比较我提供的情景或选项，展示支持证据，并建议下一步行动。"]}}}'
  mind.publisher: medrixai
  mind.upstream.repo: https://github.com/binance/binance-skills-hub
  mind.upstream.commit: da3da86eda10a32f56978372057f4a1edb41a028
  mind.upstream.license: NOASSERTION
  mind.upstream.path: skills/binance-web3/crypto-market-rank/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/binance/binance-skills-hub/da3da86eda10a32f56978372057f4a1edb41a028/skills/binance-web3/crypto-market-rank/SKILL.md"]'
license: NOASSERTION
---
