...
description: Two-stage paper screening - abstract scoring then deep dive for specific
  data extraction
when_to_use: After literature search returns results. When need to determine if paper
  contains specific data. When screening papers for relevance. When extracting methods,
  results, data from papers.
version: 1.0.0
metadata:
  mind.id: ai.medrix.skill.evaluating-paper-relevance
  ...
  mind.upstream.path: skills/research/evaluating-paper-relevance/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://github.com/kthorn/research-superpower/blob/2affbfea08b584465207680b906e208de52c4669/LICENSE",
    "https://raw.githubusercontent.com/kthorn/research-superpower/2affbfea08b584465207680b906e208de52c4669/skills/research/evaluating-paper-relevance/SKILL.md"]'
license: MIT
---
