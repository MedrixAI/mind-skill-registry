...
description: 'Guide for creating effective skills that extend agent capabilities with
  ...
  user asks to: (1) create a new skill, (2) make a skill, (3) build a skill, (4) set
  up a skill, (5) initialize a skill, (6) scaffold a skill, (7) update or modify an
  existing skill, (8) validate a skill, (9) learn about skill structure, (10) understand
  how skills work, or (11) get guidance on skill design patterns. Trigger on phrases
  like "create a skill", "new skill", "make a skill", "skill for X", "how do I create
  a skill", or "help me build a skill".'
metadata:
  mind.id: ai.medrix.skill.skill-creator
  mind.distribution: marketplace
  mind.market-primary: general
  mind.market-categories: '["general"]'
  mind.marketplace-summary: skill-creator
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Guide for creating effective skills that extend agent capabilities with specialized knowledge, workflows, or tool integrations. Use this skill when the user asks to: (1) create a new skill, (2) make a skill, (3) build a skill, (4) set up a skill, (5) initialize a skill, (6) scaffold a skill, (7) update or modify an existing skill, (8) validate a skill, (9) learn about skill structure, (10) understand how skills work, or (11) get guidance on skill design patterns. Trigger on phrases like \"create a skill\", \"new skill\", \"make a skill\", \"skill for X\", \"how do I create a skill\", or \"help me build a skill\".","starter_prompts":["Help me with skill creator. Start by asking for the goal, relevant files or context, constraints, and desired output, then complete the workflow.","Apply skill creator to the material I provide, explain the key findings or changes, and produce a polished result I can use directly.","Review my current work with skill creator, identify gaps and risks, and return an improved version with clear next steps."]},"zh-CN":{"description":"指导创建有效的 Skill，以专业知识、工作流或工具集成扩展 Agent 能力。适用于创建、搭建、初始化、更新、修改或验证 Skill，以及了解结构和设计模式。","starter_prompts":["请帮我完成skill creator。先询问目标、相关文件或上下文、约束和所需输出，然后完成整个流程。","请对我提供的材料应用skill creator，说明关键发现或修改，并产出可直接使用的结果。","请使用skill creator审查我当前的成果，识别缺口和风险，并返回改进版本及明确的后续步骤。"]}}}'
  mind.publisher: medrixai
  mind.upstream.repo: https://github.com/langchain-ai/deepagents
  mind.upstream.commit: 22d50456324e9b8c0121a3a06787e19c1b88e1aa
  mind.upstream.license: MIT
  mind.upstream.path: libs/cli/examples/skills/skill-creator/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.evidence-urls: '["https://github.com/langchain-ai/deepagents/blob/22d50456324e9b8c0121a3a06787e19c1b88e1aa/LICENSE",
    "https://raw.githubusercontent.com/langchain-ai/deepagents/22d50456324e9b8c0121a3a06787e19c1b88e1aa/libs/cli/examples/skills/skill-creator/SKILL.md"]'
license: MIT
---
