...
description: Use when creating new Claude Code skills or improving existing ones -
  ensures skills are discoverable, scannable, and effective through proper structure,
  CSO optimization, and real examples
metadata:
  mind.id: ai.medrix.skill.creating-skills
  mind.distribution: marketplace
  mind.market-primary: knowledge-learning
  mind.market-categories: '["knowledge-learning"]'
  mind.marketplace-summary: creating-skills (pr-pm)
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Use when creating new Claude Code skills or improving existing ones - ensures skills are discoverable, scannable, and effective through proper structure, CSO optimization, and real examples","starter_prompts":["Help me with creating skills. Start by asking for the question, sources or material, required depth, constraints, and output format, then complete the analysis.","Use creating skills to synthesize the sources I provide, distinguish evidence from assumptions, identify gaps or contradictions, and produce clear conclusions.","Critically review my current understanding with creating skills, challenge weak reasoning, and turn the findings into an actionable learning or research plan."]},"zh-CN":{"description":"用于创建新的 Claude Code Skill 或改进现有 Skill，通过合理结构、触发描述优化和真实示例确保 Skill 易发现、易浏览且有效。","starter_prompts":["请帮我完成creating skills。先询问研究问题、来源或材料、所需深度、约束和输出格式，然后完成分析。","请使用creating skills综合我提供的来源，区分证据与假设，识别缺口或矛盾，并形成清晰结论。","请使用creating skills批判性审查我当前的理解，挑战薄弱推理，并将发现转化为可执行的学习或研究计划。"]}}}'
  mind.publisher: medrixai
  mind.upstream.repo: https://github.com/pr-pm/prpm
  mind.upstream.commit: 903b956417062bd9fbbb1df7cee44ca8a8291126
  mind.upstream.path: .claude/skills/creating-skills/SKILL.md
  ...
  mind.upstream.evidence-urls: '["https://github.com/pr-pm/prpm/blob/903b956417062bd9fbbb1df7cee44ca8a8291126/LICENSE",
    "https://raw.githubusercontent.com/pr-pm/prpm/903b956417062bd9fbbb1df7cee44ca8a8291126/.claude/skills/creating-skills/SKILL.md"]'
license: MIT
---
