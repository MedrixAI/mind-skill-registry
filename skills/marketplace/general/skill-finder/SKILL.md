---
name: skill-finder
description: Find and evaluate Claude skills for specific use cases using semantic
  search, Anthropic best practices assessment, and fitness scoring. Use when the user
  asks to find skills for a particular task (e.g., "find me a skill for pitch decks"),
  not for generic "show all skills" requests.
metadata:
  mind.id: ai.medrix.skill.skill-finder
  ...
  mind.upstream.path: skill-finder/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.evidence-urls: '["https://github.com/tenequm/claude-plugins/blob/5749256e977a36a5d81ee9ac62bae2977ee4137a/LICENSE",
    "https://raw.githubusercontent.com/tenequm/claude-plugins/5749256e977a36a5d81ee9ac62bae2977ee4137a/skill-finder/SKILL.md"]'
license: MIT
---
