...
metadata:
  mind.id: ai.medrix.skill.markdown-to-html
  mind.distribution: marketplace
  mind.market-primary: content-creation
  mind.market-categories: '["content-creation"]'
  mind.marketplace-summary: markdown-to-html (github)
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Convert Markdown files to HTML similar to `marked.js`, `pandoc`, `gomarkdown/markdown`, or similar tools; or writing custom script to convert markdown to html and/or working on web template systems like `jekyll/jekyll`, `gohugoio/hugo`, or similar web templating systems that utilize markdown documents, converting them to html. Use when asked to \"convert markdown to html\", \"transform md to html\", \"render markdown\", \"generate html from markdown\", or when working with .md files and/or web a templating system that converts markdown to HTML output. Supports CLI and Node.js workflows with GFM, CommonMark, and standard Markdown flavors.","starter_prompts":["Help me create markdown to html. Start by asking for the audience, purpose, source material, tone, format, and constraints, then produce a polished result.","Use markdown to html to improve the draft or assets I provide, explain the most important changes, and deliver the revised version.","Create three strong directions for markdown to html from my brief, compare their tradeoffs, and develop the best option."]},"zh-CN":{"description":"将 Markdown 文件转换为 HTML，支持常用 CLI、Node.js 和模板系统工作流，以及 GFM、CommonMark 等格式。","starter_prompts":["请帮我完成markdown to html。先询问受众、目的、素材、语气、格式和约束，然后产出可直接使用的成品。","请用markdown to html改进我提供的草稿或素材，说明最重要的修改，并交付修订后的版本。","请根据我的简报为markdown to html提出三个有力方向，比较各自取舍，并完善最佳方案。"]}}}'
  mind.publisher: medrixai
  mind.upstream.repo: https://github.com/github/awesome-copilot
  mind.upstream.commit: fe4442e4cbfd383bbde7ff51f9a79ce7f868707e
  mind.upstream.path: skills/markdown-to-html/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://github.com/github/awesome-copilot/blob/fe4442e4cbfd383bbde7ff51f9a79ce7f868707e/LICENSE",
    "https://raw.githubusercontent.com/github/awesome-copilot/fe4442e4cbfd383bbde7ff51f9a79ce7f868707e/skills/markdown-to-html/SKILL.md"]'
license: MIT
---
