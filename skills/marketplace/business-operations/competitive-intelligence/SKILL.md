...
metadata:
  mind.id: ai.medrix.skill.competitive-intelligence
  mind.distribution: marketplace
  mind.market-primary: business-operations
  mind.market-categories: '["business-operations"]'
  mind.marketplace-summary: competitive-intelligence (anthropics)
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Research your competitors and build an interactive battlecard. Outputs an HTML artifact with clickable competitor cards and a comparison matrix. Trigger with \"competitive intel\", \"research competitors\", \"how do we compare to [competitor]\", \"battlecard for [competitor]\", or \"what''s new with [competitor]\".","starter_prompts":["Help me with competitive intelligence. Start by asking for the business goal, stakeholders, available inputs, constraints, and desired decision or deliverable, then complete the workflow.","Apply competitive intelligence to the material I provide, identify the most important findings, risks, and evidence gaps, and produce a decision-ready result.","Review my existing competitive intelligence work, correct weak assumptions or missing details, and return an improved version with clear next actions."]},"zh-CN":{"description":"研究竞争对手并生成交互式战卡，输出包含可点击竞争对手卡片和比较矩阵的 HTML。适用于竞争情报、竞品研究、对比分析和竞品动态追踪。","starter_prompts":["请帮我完成competitive intelligence。先询问业务目标、利益相关者、现有输入、约束以及需要支持的决策或交付物，然后完成整个流程。","请对我提供的材料开展competitive intelligence，找出最重要的发现、风险和证据缺口，并输出可用于决策的结果。","请审查我现有的competitive intelligence成果，修正薄弱假设和遗漏细节，并给出改进版本及明确的后续行动。"]}}}'
  ...
  mind.upstream.path: sales/skills/competitive-intelligence/SKILL.md
  ...
  mind.upstream.evidence-urls: '["https://github.com/anthropics/knowledge-work-plugins/blob/47caa757e4730eb8daf7d335470f692d4a68b59e/sales/LICENSE",
    "https://raw.githubusercontent.com/anthropics/knowledge-work-plugins/47caa757e4730eb8daf7d335470f692d4a68b59e/sales/skills/competitive-intelligence/SKILL.md"]'
license: Apache-2.0
---
