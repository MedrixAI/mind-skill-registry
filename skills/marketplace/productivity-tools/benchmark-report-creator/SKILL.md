...
description: Use PROACTIVELY when creating research reports, experiment writeups,
  technical whitepapers, or empirical study documentation. Orchestrates the complete
  benchmark report pipeline with structure, diagrams, hi-res PNG capture, and PDF
  export. Provides working scripts, CSS templates, and complete command sequences
  for publication-quality AI/ML benchmark reports. Not for slides, blog posts, or
  simple README files.
author: Connor
category: benchmarking
metadata:
  mind.id: ai.medrix.skill.benchmark-report-creator
  mind.distribution: marketplace
  mind.market-primary: productivity-tools
  mind.market-categories: '["productivity-tools"]'
  mind.marketplace-summary: benchmark-report-creator (cskiro)
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Use PROACTIVELY when creating research reports, experiment writeups, technical whitepapers, or empirical study documentation. Orchestrates the complete benchmark report pipeline with structure, diagrams, hi-res PNG capture, and PDF export. Provides working scripts, CSS templates, and complete command sequences for publication-quality AI/ML benchmark reports. Not for slides, blog posts, or simple README files.","starter_prompts":["Help me use benchmark report creator for my task. Start by asking for the goal, inputs, deadline, constraints, and desired output, then complete the workflow.","Apply benchmark report creator to the material I provide, identify missing or inefficient steps, and produce a clearer, more reliable result.","Review my existing approach with benchmark report creator and turn it into a practical checklist or plan with priorities, owners, and validation steps."]},"zh-CN":{"description":"主动用于创建研究报告、实验报告、技术白皮书或实证研究文档。编排完整的基准报告流程，包括结构设计、图表、高分辨率截图和 PDF 导出。不要用于幻灯片、博客或简单 README。","starter_prompts":["请帮我用benchmark report creator完成任务。先询问目标、输入、截止时间、约束和所需输出，然后完成整个流程。","请对我提供的材料应用benchmark report creator，找出缺失或低效步骤，并产出更清晰、更可靠的结果。","请使用benchmark report creator审查我现有的方法，并将其整理为包含优先级、负责人和验证步骤的实用清单或计划。"]}}}'
  mind.publisher: medrixai
  mind.upstream.repo: https://github.com/cskiro/claudex
  mind.upstream.commit: 83e2be1c34eafdd9ee8f3107728b60f80e1db98f
  mind.upstream.license: NOASSERTION
  mind.upstream.path: plugins/benchmark-report-creator/skills/benchmark-report-creator/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/cskiro/claudex/83e2be1c34eafdd9ee8f3107728b60f80e1db98f/plugins/benchmark-report-creator/skills/benchmark-report-creator/SKILL.md"]'
license: NOASSERTION
---
