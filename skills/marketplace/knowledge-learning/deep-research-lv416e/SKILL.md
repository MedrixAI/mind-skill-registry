---
name: deep-research-lv416e
description: Conduct comprehensive, multi-source research on any topic using web search,
  documentation lookup, and critical analysis. This skill should be used when users
  request thorough investigation, deep research, or comprehensive analysis of topics
  including but not limited to AI systems, technology trends, academic subjects, business
  strategies, or current events. | 任意のトピックに対して、Web検索、ドキュメント参照、批判的分析を用いた包括的な調査を実施。徹底的な調査、詳細なリサーチ、包括的な分析が必要な場合や、AIシステム、技術トレンド、学術的テーマ、ビジネス戦略、時事問題などについて深く知りたい場合に使用。
metadata:
  mind.id: ai.medrix.skill.deep-research-lv416e
  mind.distribution: marketplace
  mind.market-primary: knowledge-learning
  mind.market-categories: '["knowledge-learning"]'
  mind.marketplace-summary: deep-research (lv416e)
  mind.presentation: '{"default_locale":"en-US","locales":{"en-US":{"description":"Conduct comprehensive, multi-source research on any topic using web search, documentation lookup, and critical analysis. This skill should be used when users request thorough investigation, deep research, or comprehensive analysis of topics including but not limited to AI systems, technology trends, academic subjects, business strategies, or current events. | 任意のトピックに対して、Web検索、ドキュメント参照、批判的分析を用いた包括的な調査を実施。徹底的な調査、詳細なリサーチ、包括的な分析が必要な場合や、AIシステム、技術トレンド、学術的テーマ、ビジネス戦略、時事問題などについて深く知りたい場合に使用。","starter_prompts":["Help me with deep research lv416e. Start by asking for the question, sources or material, required depth, constraints, and output format, then complete the analysis.","Use deep research lv416e to synthesize the sources I provide, distinguish evidence from assumptions, identify gaps or contradictions, and produce clear conclusions.","Critically review my current understanding with deep research lv416e, challenge weak reasoning, and turn the findings into an actionable learning or research plan."]},"zh-CN":{"description":"使用网页搜索、文档查找和批判性分析，对任意主题开展多来源综合研究。适用于 AI 系统、技术趋势、学术主题、商业战略或时事等深入调查。","starter_prompts":["请帮我完成deep research lv416e。先询问研究问题、来源或材料、所需深度、约束和输出格式，然后完成分析。","请使用deep research lv416e综合我提供的来源，区分证据与假设，识别缺口或矛盾，并形成清晰结论。","请使用deep research lv416e批判性审查我当前的理解，挑战薄弱推理，并将发现转化为可执行的学习或研究计划。"]}}}'
  mind.publisher: medrixai
  mind.upstream.repo: https://github.com/lv416e/dotfiles
  mind.upstream.commit: adcf0c592d2b0c1a1335df7230279aad9b036aed
  mind.upstream.license: NOASSERTION
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.path: dot_claude/skills/deep-research/SKILL.md
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/lv416e/dotfiles/adcf0c592d2b0c1a1335df7230279aad9b036aed/dot_claude/skills/deep-research/SKILL.md"]'
license: NOASSERTION
---
