---
name: task-breakdown
description: Convert technical designs into actionable, sequenced implementation tasks.
  Create clear coding tasks that enable incremental progress, respect dependencies,
  and provide a roadmap for systematic feature development.
license: MIT
...
metadata:
  ...
  author: Kiro Team
  version: 1.0.0
  mind.id: ai.medrix.skill.task-breakdown
  ...
  mind.upstream.path: skills/task-breakdown/SKILL.md
  mind.upstream.evidence-urls: '["https://github.com/jasonkneen/kiro/blob/22577b636dc3095f774ace4c846034514d9fa071/",
    "https://smithery.ai/skills/jasonkneen/task-breakdown"]'
---
