---
name: html-sprite-animation
description: 'Generate a Sprite Animation as a single-file HTML document. 像素美术 + kinetic 字体的解说帧, 纯 CSS 循环, 可录视频 Best for: marketing & branding. Format: 竖版/横版均可.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-sprite-animation
  ...
  mind.upstream.path: next/src/lib/templates/skills/sprite-animation/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/sprite-animation/SKILL.md"]'
---
