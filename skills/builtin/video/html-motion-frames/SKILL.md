---
name: html-motion-frames
description: 'Generate a Motion Frames as a single-file HTML document. 可循环 CSS 动效组合: 旋转环、地球仪、计时器、视差标签 Category: video / animation frames. Best for: marketing & branding. Format: 桌面 hero.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-motion-frames
  ...
  mind.upstream.path: next/src/lib/templates/skills/motion-frames/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/motion-frames/SKILL.md"]'
---
