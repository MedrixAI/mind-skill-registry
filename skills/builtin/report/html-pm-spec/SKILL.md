---
name: html-pm-spec
description: 'Generate a Product Spec / PRD as a single-file HTML document. 问题 + 成功指标 + 范围 + user stories + 设计 + 发布 + 待解决 Category: document / documentation. Best for: product & startup. Format: 长页面.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-pm-spec
  ...
  mind.upstream.path: next/src/lib/templates/skills/pm-spec/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/pm-spec/SKILL.md"]'
---
