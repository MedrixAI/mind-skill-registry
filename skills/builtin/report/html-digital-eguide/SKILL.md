---
name: html-digital-eguide
description: 'Generate a Digital E-Guide as a single-file HTML document. 两页跨页电子指南, 封面 + 课程页 + pull-quote + 步骤列表 Category: article / long-form content. Best for: marketing & branding. Format: 双页预览.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-digital-eguide
  ...
  mind.upstream.path: next/src/lib/templates/skills/digital-eguide/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/digital-eguide/SKILL.md"]'
---
