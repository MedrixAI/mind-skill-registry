---
name: html-eng-runbook
description: 'Generate a Engineering Runbook as a single-file HTML document. 服务概述 + alerts 表 + dashboards + 操作命令 + on-call + 事故清单 Category: document / documentation. Best for: engineering & technical. Format: 长页面.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-eng-runbook
  ...
  mind.upstream.path: next/src/lib/templates/skills/eng-runbook/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/eng-runbook/SKILL.md"]'
---
