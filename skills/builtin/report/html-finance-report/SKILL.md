...
description: 'Generate a Finance Report as a single-file HTML document. Masthead + KPI + 收入/烧钱图 + P&L 表 + 重点 + 展望 Best for: finance & business. Format: 长页面.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-finance-report
  ...
  mind.upstream.path: next/src/lib/templates/skills/finance-report/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/finance-report/SKILL.md"]'
---
