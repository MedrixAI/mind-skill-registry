...
description: 'Generate a Meeting Notes as a single-file HTML document. 标题 + 出席 + 议程 + 决议 + action items + 下次 Category: document / documentation. Best for: operations & management. Format: 长页面.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-meeting-notes
  ...
  mind.upstream.path: next/src/lib/templates/skills/meeting-notes/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/meeting-notes/SKILL.md"]'
---
