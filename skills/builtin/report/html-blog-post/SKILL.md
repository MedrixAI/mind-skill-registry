---
name: html-blog-post
description: 'Generate a Blog Post as a single-file HTML document. 杂志感长文, 含 masthead、hero、figures、pull quote、作者署名 Category: article / long-form content. Best for: marketing & branding. Format: 长页面.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-blog-post
  ...
  mind.upstream.path: next/src/lib/templates/skills/blog-post/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/blog-post/SKILL.md"]'
---
