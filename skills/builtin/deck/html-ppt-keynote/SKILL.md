---
name: html-ppt-keynote
description: 'Generate a Keynote-style Slides as a single-file HTML document. 苹果 Keynote 级别幻灯片, 一屏一卡, 键盘左右切换 Category: slide deck / presentation. Best for: marketing & branding. Format: 16:9 (1280×720).'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-ppt-keynote
  ...
  mind.upstream.path: next/src/lib/templates/skills/ppt-keynote/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/ppt-keynote/SKILL.md"]'
---
