---
name: html-deck-xhs-pastel
description: 'Generate a Pastel Slow-life Deck as a single-file HTML document. 奶油底 + 柔光 blob + 马卡龙圆角卡片 + Playfair 斜体序号 Category: slide deck / presentation. Best for: personal & lifestyle. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-xhs-pastel
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-xhs-pastel/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-xhs-pastel/SKILL.md"]'
---
