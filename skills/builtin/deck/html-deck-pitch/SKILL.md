---
name: html-deck-pitch
description: 'Generate a Investor Pitch Deck as a single-file HTML document. 10 页融资 deck, 白底 + 蓝紫渐变 hero, traction 柱状, $X.XM ask Category: slide deck / presentation. Best for: finance & business. Format: 16:9 ×10.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-pitch
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-pitch/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-pitch/SKILL.md"]'
---
