---
name: html-deck-hermes-cyber
description: 'Generate a Hermes Cyber Terminal Deck as a single-file HTML document. 黑底 + CRT 网格扫描线 + $ 命令行标题 + 薄荷绿大字 + 三档 tag Category: slide deck / presentation. Best for: engineering & technical. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-hermes-cyber
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-hermes-cyber/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-hermes-cyber/SKILL.md"]'
---
