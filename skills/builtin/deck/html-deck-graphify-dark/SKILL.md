---
name: html-deck-graphify-dark
description: 'Generate a Graphify Dark Deck as a single-file HTML document. 深夜渐变 + 漂浮 orbs + SVG 力导向图谱 + JetBrains Mono Category: slide deck / presentation. Best for: engineering & technical. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-graphify-dark
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-graphify-dark/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-graphify-dark/SKILL.md"]'
---
