---
name: html-deck-course-module
description: 'Generate a Course Module Deck as a single-file HTML document. 暖纸背景 + Playfair, 左侧学习目标常驻, 含 MCQ 自测页 Category: slide deck / presentation. Best for: education & training. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-course-module
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-course-module/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-course-module/SKILL.md"]'
---
