---
name: html-deck-presenter-mode
description: 'Generate a Presenter Mode Deck as a single-file HTML document. tokyo-night 默认主题, T 切换 5 主题, S 打开提词器 popup Category: slide deck / presentation. Best for: engineering & technical. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-presenter-mode
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-presenter-mode/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-presenter-mode/SKILL.md"]'
---
