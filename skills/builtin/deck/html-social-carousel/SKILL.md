---
name: html-social-carousel
description: 'Generate a Social Carousel as a single-file HTML document. 三张方形卡片轮播, 标题串联, 品牌 mark + 编号 Category: social media card / image. Best for: marketing & branding. Format: 1080×1080 ×3.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-social-carousel
  ...
  mind.upstream.path: next/src/lib/templates/skills/social-carousel/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/social-carousel/SKILL.md"]'
---
