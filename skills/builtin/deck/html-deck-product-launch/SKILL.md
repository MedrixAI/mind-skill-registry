---
name: html-deck-product-launch
description: 'Generate a Product Launch Deck as a single-file HTML document. 暗 hero + 亮内容, 橙→桃 accent, 特性卡 + 定价 + CTA Category: slide deck / presentation. Best for: marketing & branding. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-product-launch
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-product-launch/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-product-launch/SKILL.md"]'
---
