---
name: html-deck-safety-alert
description: 'Generate a Testing / Safety Alert Deck as a single-file HTML document. 红琥珀警示色 + hazard 条纹 + L1/L2/L3 tier 卡片 + 删除线标题 Category: slide deck / presentation. Best for: engineering & technical. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-safety-alert
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-safety-alert/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-safety-alert/SKILL.md"]'
---
