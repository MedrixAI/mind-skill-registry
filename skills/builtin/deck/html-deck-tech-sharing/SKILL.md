---
name: html-deck-tech-sharing
description: 'Generate a Tech Sharing Deck as a single-file HTML document. GitHub-dark + JetBrains Mono + 终端代码块, 含 agenda + Q&A Category: slide deck / presentation. Best for: engineering & technical. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-tech-sharing
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-tech-sharing/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-tech-sharing/SKILL.md"]'
---
