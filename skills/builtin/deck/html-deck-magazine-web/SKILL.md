---
name: html-deck-magazine-web
description: 'Generate a Magazine Web Deck as a single-file HTML document. 电子杂志 × 电子墨水风, WebGL 流体背景 + 衬线 display Category: slide deck / presentation. Best for: marketing & branding. Format: 16:9 横向翻页.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-magazine-web
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-magazine-web/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-magazine-web/SKILL.md"]'
---
