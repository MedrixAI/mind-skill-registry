---
name: html-poster-hero
description: 'Generate a Marketing Poster as a single-file HTML document. 竖版海报 / 朋友圈分享图, 强视觉冲击 Best for: marketing & branding. Format: 1080×1920 竖版.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-poster-hero
  ...
  mind.upstream.path: next/src/lib/templates/skills/poster-hero/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/poster-hero/SKILL.md"]'
---
