---
name: html-deck-blueprint
description: 'Generate a Knowledge Arch Blueprint as a single-file HTML document. 奶油纸 + 锈红 + 蓝图网格 mask + 黑边硬卡片 + pipeline 盒 Category: slide deck / presentation. Best for: engineering & technical. Format: 16:9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-blueprint
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-blueprint/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-blueprint/SKILL.md"]'
---
