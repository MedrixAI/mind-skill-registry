---
name: html-deck-xhs-post
description: 'Generate a Xiaohongshu Post Deck as a single-file HTML document. 9 页 3:4 竖版图文, 暖 pastel + 虚线 sticker 卡片 Category: slide deck / presentation. Best for: marketing & branding. Format: 810×1080 ×9.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-deck-xhs-post
  ...
  mind.upstream.path: next/src/lib/templates/skills/deck-xhs-post/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/deck-xhs-post/SKILL.md"]'
---
