---
name: html-frame-macos-notification
description: 'Generate a macOS Notification Banner as a single-file HTML document. 拟真 macOS 通知 banner + app icon + 标题正文, 适合 video overlay / 产品发布预告 Category: social media card / image. Format: 1920×1080 视频或 480×120 横幅.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-frame-macos-notification
  ...
  mind.upstream.path: next/src/lib/templates/skills/frame-macos-notification/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/frame-macos-notification/SKILL.md"]'
---
