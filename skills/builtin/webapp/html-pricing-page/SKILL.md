---
name: html-pricing-page
description: 'Generate a Pricing Page as a single-file HTML document. 三档定价 + 特性对比表 + FAQ Category: web prototype / mockup. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-pricing-page
  ...
  mind.upstream.path: next/src/lib/templates/skills/pricing-page/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/pricing-page/SKILL.md"]'
---
