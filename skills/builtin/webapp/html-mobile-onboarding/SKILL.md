---
name: html-mobile-onboarding
description: 'Generate a Mobile Onboarding as a single-file HTML document. 三个手机框并排: splash / value-prop / sign-in Category: mobile app UI. Best for: design & creative. Format: 3 × iPhone.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-mobile-onboarding
  ...
  mind.upstream.path: next/src/lib/templates/skills/mobile-onboarding/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/mobile-onboarding/SKILL.md"]'
---
