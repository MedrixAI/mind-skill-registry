---
name: html-web-proto-editorial
description: 'Generate a Editorial Prototype as a single-file HTML document. Editorial-minimalist: 暖色单色 canvas + serif display + grotesque body Category: web prototype / mockup. Best for: design & creative. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-web-proto-editorial
  ...
  mind.upstream.path: next/src/lib/templates/skills/web-proto-editorial/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/web-proto-editorial/SKILL.md"]'
---
