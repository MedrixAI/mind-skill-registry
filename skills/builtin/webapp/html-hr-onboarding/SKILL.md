---
name: html-hr-onboarding
description: 'Generate a HR Onboarding as a single-file HTML document. 首周日程 + buddy + 学习路径 + 设备 + 完成标准 Category: document / documentation. Format: 长页面.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-hr-onboarding
  ...
  mind.upstream.path: next/src/lib/templates/skills/hr-onboarding/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/hr-onboarding/SKILL.md"]'
---
