---
name: html-kanban-board
description: 'Generate a Kanban Board as a single-file HTML document. To do / In progress / In review / Done 四列, 卡片 + 头像 + 泳道 Category: dashboard / analytics panel. Best for: operations & management. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-kanban-board
  ...
  mind.upstream.path: next/src/lib/templates/skills/kanban-board/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/kanban-board/SKILL.md"]'
---
