---
name: html-invoice
description: 'Generate a Printable Invoice as a single-file HTML document. 标准发票: 寄件/收件 + 明细 + 税 + 总额 + 付款指引 Best for: finance & business. Format: A4.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-invoice
  ...
  mind.upstream.path: next/src/lib/templates/skills/invoice/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/invoice/SKILL.md"]'
---
