---
name: html-gamified-app
description: 'Generate a Gamified App as a single-file HTML document. 三屏: 封面 / 今日任务带 XP / 任务详情, 暗色舞台 Category: mobile app UI. Best for: personal & lifestyle. Format: 3 × iPhone.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-gamified-app
  ...
  mind.upstream.path: next/src/lib/templates/skills/gamified-app/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/gamified-app/SKILL.md"]'
---
