---
name: html-live-dashboard
description: 'Generate a Live Team Dashboard as a single-file HTML document. Notion 风团队仪表板, KPI + 7 日 sparkline + activity feed + 任务表 Category: dashboard / analytics panel. Best for: operations & management. Format: 桌面长页.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-live-dashboard
  ...
  mind.upstream.path: next/src/lib/templates/skills/live-dashboard/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/live-dashboard/SKILL.md"]'
---
