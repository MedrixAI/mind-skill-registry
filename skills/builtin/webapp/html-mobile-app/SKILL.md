---
name: html-mobile-app
description: 'Generate a Mobile App Screen as a single-file HTML document. 像素级 iPhone 15 Pro 边框, 一屏 app 截图 Category: mobile app UI. Best for: design & creative. Format: iPhone 15 Pro frame.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-mobile-app
  ...
  mind.upstream.path: next/src/lib/templates/skills/mobile-app/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/mobile-app/SKILL.md"]'
---
