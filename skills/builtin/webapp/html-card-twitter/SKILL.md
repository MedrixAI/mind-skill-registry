...
description: 'Generate a Twitter Share Card as a single-file HTML document. 推特金句 / 数据卡, 适合配推文 Category: social media card / image. Best for: marketing & branding. Format: 1600×900 (16:9).'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-card-twitter
  ...
  mind.upstream.path: next/src/lib/templates/skills/card-twitter/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/card-twitter/SKILL.md"]'
---
