---
name: html-dating-web
description: 'Generate a Dating / Community Dashboard as a single-file HTML document. 消费感配对仪表板: 信号 ticker + KPI + 30 天柱状 + 趋势 Category: dashboard / analytics panel. Best for: personal & lifestyle. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-dating-web
  ...
  mind.upstream.path: next/src/lib/templates/skills/dating-web/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/dating-web/SKILL.md"]'
---
