---
name: html-social-media-dashboard
description: 'Generate a Social Media Dashboard as a single-file HTML document. 平台切换 + 粉丝/互动 KPI + 增长曲线 + Top post + 热门话题 Category: dashboard / analytics panel. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-social-media-dashboard
  ...
  mind.upstream.path: next/src/lib/templates/skills/social-media-dashboard/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/social-media-dashboard/SKILL.md"]'
---
