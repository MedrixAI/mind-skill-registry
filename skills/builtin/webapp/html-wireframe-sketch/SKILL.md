---
name: html-wireframe-sketch
description: 'Generate a Wireframe Sketch as a single-file HTML document. 网格背景 + marker 笔触 + 多 tab + sticky note + scribble 图表 Category: web prototype / mockup. Best for: design & creative. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-wireframe-sketch
  ...
  mind.upstream.path: next/src/lib/templates/skills/wireframe-sketch/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/wireframe-sketch/SKILL.md"]'
---
