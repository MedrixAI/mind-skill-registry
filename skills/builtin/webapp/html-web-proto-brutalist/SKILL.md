---
name: html-web-proto-brutalist
description: 'Generate a Brutalist Prototype as a single-file HTML document. Swiss industrial-print 风: 单字 grotesque、巨数字、ASCII 装饰 Category: web prototype / mockup. Best for: design & creative. Format: 桌面 1440.'
license: MIT
compatibility: Requires the submit_html artifact tool.
allowed-tools:
- submit_html
metadata:
  mind.id: ai.medrix.skill.builtin.html-web-proto-brutalist
  ...
  mind.upstream.path: next/src/lib/templates/skills/web-proto-brutalist/SKILL.md
  mind.upstream.import-mode: curated-fork
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://raw.githubusercontent.com/nexu-io/html-anything/d0efb1eaa3b65c731709981718cd5a0a0d4e8f71/next/src/lib/templates/skills/web-proto-brutalist/SKILL.md"]'
---
