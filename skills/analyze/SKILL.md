---
name: analyze
description: Universal multi-perspective analyzer for any topic, file, idea, or decision.
  Extract key points, find gaps/risks, identify improvements with actionable plans.
metadata:
  mind.id: ai.medrix.skill.analyze
  ...
  mind.upstream.path: analyze/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://github.com/bntvllnt/agent-skills/blob/5f6f937ad7e0bd02d8cbfbf4e3db6e460f10e469/LICENSE",
    "https://raw.githubusercontent.com/bntvllnt/agent-skills/5f6f937ad7e0bd02d8cbfbf4e3db6e460f10e469/analyze/SKILL.md"]'
license: MIT
---
