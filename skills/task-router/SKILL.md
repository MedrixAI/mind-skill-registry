---
name: task-router
description: 'Decision matrix for choosing optimal approach to any task. Helps Claude
...
- Read
metadata:
  mind.id: ai.medrix.skill.task-router
  ...
  mind.upstream.path: skills/task-router/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://github.com/arpitnath/claude-capsule-kit/blob/298ac241d8d4ec7e5387c8ea42bec02071779b57/LICENSE",
    "https://raw.githubusercontent.com/arpitnath/claude-capsule-kit/298ac241d8d4ec7e5387c8ea42bec02071779b57/skills/task-router/SKILL.md"]'
license: MIT
---
