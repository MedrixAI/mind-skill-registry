---
name: canvas
description: '**The primary skill for terminal TUI components.** Covers spawning,
  controlling, and interacting with terminal canvases.

  Use when displaying calendars, documents, or flight bookings.

  '
metadata:
  mind.id: ai.medrix.skill.canvas
  ...
  mind.upstream.path: canvas/skills/canvas/SKILL.md
  mind.upstream.import-mode: exact-snapshot
  mind.upstream.license: MIT
  mind.upstream.evidence-urls: '["https://github.com/dvdsgl/claude-canvas/blob/2a88ac56bc38e5ab37c5619952686f757935ab80/LICENSE",
    "https://raw.githubusercontent.com/dvdsgl/claude-canvas/2a88ac56bc38e5ab37c5619952686f757935ab80/canvas/skills/canvas/SKILL.md"]'
license: MIT
---
